...
- Slack channel IDs: `#updates` C09PZ4C3F3R, `#roadmap` C09R5DDKFTJ, `#wins` C09QJAGLJ3E, `#suggestions` C09R929J8V6, `#social` C09R5D9FTH6, `#annoucements` C09QELKGALC, `#core-features` C09Q87HJX4P. (`#boardroom`: created at team launch — get ID via channel search.)
